...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="fixed inset-x-0 top-0 z-100 flex h-full items-center justify-center overflow-y-auto bg-ink-900/60 backdrop-blur-md p-0 sm:items-center sm:p-4"
      ...
      >
        ...
        >
          <div
            class="relative flex h-auto max-h-[100dvh] w-full my-0 max-w-2xl flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl ring-1 ring-ink-900/5 sm:my-6 sm:max-h-[85vh] sm:rounded-3xl"
            role="dialog"
            aria-modal="true"
