...
<template>
  <section class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
    <article class="rounded-3xl border border-brand-200 bg-brand-50 p-5">
      ...
      <p class="text-xs font-bold text-brand-800">Receitas mensais</p>
    ...
    <article class="rounded-3xl border border-coral-200 bg-coral-50 p-5">
      ...
      <p class="text-xs font-bold text-coral-800">Gastos mensais</p>
    ...
    >
      ...
      <p class="text-xs font-bold text-ink-600">Saldo mensal</p>
      <p class="mt-1 font-display text-2xl font-bold text-ink-900">
    ...
    <article class="rounded-3xl bg-ink-900 p-5 text-white">
      ...
      <p class="text-xs font-bold text-ink-300">Saldo projetado no ano</p>
