			...
			{loading ? (
				...
				<div className="space-y-2">
					...
					{[...unpaid, ...paid].map((bill) => {
						...
						const isDueSoon =
							!bill.isPaid && daysUntilDue <= 3 && daysUntilDue >= 0;
						...
						return (
							...
							>
								...
								<div className="flex-1 min-w-0">
									<div className="flex items-center gap-2 flex-wrap">
										...
										{bill.categoryName && (
											<span
												...
												style={{
													backgroundColor: `${bill.categoryColor}22`,
													color: bill.categoryColor ?? "#6366f1",
												}}
											>
												{bill.categoryName}
											</span>
									...
									<p
										className={`text-xs mt-0.5 ${isOverdue ? "text-red-400" : isDueSoon ? "text-amber-400" : "text-zinc-500"}`}
									>
								...
								<div className="text-right shrink-0">
									<p
										className={`font-bold ${bill.isPaid ? "text-zinc-500" : "text-zinc-100"}`}
									>
