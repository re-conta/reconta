					...
					{accounts.length === 0 ? (
						...
						<div className="space-y-2">
							{accounts.map((acc) => (
								<div
									key={acc.id}
									className="flex items-center gap-3 rounded-lg p-3 bg-zinc-800/50 border border-zinc-800"
								>
									...
									<p
										className={`text-sm font-semibold ${acc.balance >= 0 ? "text-zinc-100" : "text-red-400"}`}
									>
